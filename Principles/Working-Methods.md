...
[https://time.geekbang.org/column/article/292928](https://time.geekbang.org/column/article/292928)



[https://towardsdatascience.com/data-scientist-should-know-software-engineering-best-practices-f964ec44cada](https://towardsdatascience.com/data-scientist-should-know-software-engineering-best-practices-f964ec44cada)
...
- ios14 跨团队
- ios14 指标设计 需求明确了 agile了么
- global did 
    - agile 没有方向 ds能够面对不明确的需求吗
- 冷启动：穿山甲+中国区+浩阳的做法
    - 跳出程序员思维 ---》 全局的角度
        - 具体的问题-》冷启动-》穿山甲-》广告投放-》字节：how much money？
    - 需求拆分与管理-拆的特别细，到底什么是重要的？
- 验证类的数据工作-真的可测吗，是一个测试吗
- ios和RD的合作 - P0 P1 紧急管理与长期管理
